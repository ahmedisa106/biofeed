                    ...
                    <div class="row">
                        <div class="col-lg-3 col-lg-offset-2 col-sm-5 col-sm-offset-1 col-xs-12">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" data-validation-required-message="Please enter" required="required"  placeholder="Your Name" id="name" name="name"  class="form-control">
                        ...
                        <div class="col-lg-5 col-sm-5 col-xs-12">
                            <div class="form-group form-group-text">   <div class="input-group">
                                    <textarea data-validation-required-message="Please enter a message." required id="message" name="message" placeholder="Your Message *" class="form-control" rows="9"></textarea>
