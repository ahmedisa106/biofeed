            ...
            <div class="tab-content">
              ...
              <div class="tab-pane @if($loop->first) active @endif" id="{{ $lang->display_lang }}">
                <div class="form-group">
                  ...
                  <div class="form-group">
                      {{-- title --}}
                      <label class="control-label col-sm-2" for="title">{{__('widgetsmodule::widgets.title_2')}} ({{ $lang->display_lang }}):</label>
                      <div class="col-sm-8">
                          <input data-validation="length alphanumeric"  value="{{ ValueOf($slider, $lang, 'title_2') }}" data-validation-length="min4" type="text" autocomplete="off" class="form-control"
                                 name="{{$lang->lang}}[title_2]" data-validation="alphanumeric" @if ($loop->first) required @endif>
                      </div>
                  </div>
                  <div class="form-group">
                      {{-- title --}}
                      <label class="control-label col-sm-2" for="title">{{__('widgetsmodule::widgets.title_3')}} ({{ $lang->display_lang }}):</label>
                      <div class="col-sm-8">
                          <input data-validation="length alphanumeric"  value="{{ ValueOf($slider, $lang, 'title_3') }}" data-validation-length="min4" type="text" autocomplete="off" class="form-control"
                                 name="{{$lang->lang}}[title_3]" data-validation="alphanumeric" @if ($loop->first) required @endif>
                      </div>
                  </div>
