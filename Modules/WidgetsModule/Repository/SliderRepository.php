...
class SliderRepository
{
  ...
  public function update($id, $data, $data_trans)
  {
    ...
    foreach (\LanguageHelper::getLang() as $lang) {
      ...
      if ($slider->hasTranslation('' . $lang->lang)) {
      } else {
        $slider->translateOrNew('' . $lang->lang);
            }

      $slider->translate('' . $lang->lang)->title = $data_trans[$lang->lang]['title'];
      $slider->translate('' . $lang->lang)->title_2 = $data_trans[$lang->lang]['title_2'];
      $slider->translate('' . $lang->lang)->title_3 = $data_trans[$lang->lang]['title_3'];
